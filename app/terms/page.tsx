...
export default function TermsPage() {
  ...
  const sections = [
    { num: '1', title: s.s1Title, content: <><p>{s.s1p1}</p><p>{s.s1p2}</p></> },
    { num: '2', title: s.s2Title, content: <><p>{s.s2p1}</p><ul className="list-disc list-inside space-y-2"><li>{s.s2b1}</li><li>{s.s2b2}</li><li>{s.s2b3}</li><li>{s.s2b4}</li></ul></> },
    { num: '3', title: s.s3Title, content: <><p>{s.s3p1}</p><p>{s.s3p2}</p><p>{s.s3p3}</p></> },
    { num: '4', title: s.s4Title, content: <><p>{s.s4p1}</p><p>{s.s4p2}</p></> },
    { num: '5', title: s.s5Title, content: <><p>{s.s5p1}</p><p>{s.s5p2}</p></> },
    { num: '6', title: s.s6Title, content: <><p>{s.s6p1}</p><p>{s.s6p2}</p><p>{s.s6p3}</p></> },
    { num: '7', title: s.s7Title, content: <><p>{s.s7p1}</p><p>{s.s7p2}</p></> },
    { num: '8', title: s.s8Title, content: <><p>{s.s8p1}</p></> },
    { num: '9', title: s.s9Title, content: <><p>{s.s9p1}</p></> },
    { num: '10', title: s.s10Title, content: <><p>{s.s10p1}</p></> },
  ];
